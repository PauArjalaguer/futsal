...
function redimensionar_jpeg($img_original, $img_nueva, $img_nueva_anchura, $img_nueva_altura, $img_nueva_calidad) {
     list($ample, $alt, $tipus, $atr) = getimagesize($img_original);
     $prop_org=$ample/$alt;
     
     echo " ".$ample."px  ".$alt." px - Prop org: $prop_org";
     $img_nueva_altura=$img_nueva_anchura/$prop_org;
