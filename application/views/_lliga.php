            ...
            <div class="tabs-content" data-tabs-content="example-tabs">
                ...
                <div class="tabs-panel" id="resultsTab">
                    ...
                    <table>
                        ...
                        foreach ($get_results_by_idLeague_and_idRound as $row):
                            ...
                            echo "\n\t\t<td width=100 style='background-color:#828282; color:#fff; font-size:14px; font-weight:bold; text-align:center;'>" . $row->localResult . " - " . $row->visitorResult . "</td>";
                ...
                <div class="tabs-panel" id="calendarTab">
                    <table>
                        ...
                        <?php
                        $idR = '';
						//echo "<pre>";print_r($get_next_matches_by_idLeague);echo "</pre>";
