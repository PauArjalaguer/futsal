<div class="row" id="content" style='padding:12px;'><div  class="large-12 medium-12 columns">
        <div class="row">
            ...
            <ul class="tabs" data-tabs id="example-tabs">
                <li class="tabs-title is-active"><a class="tabAactive" href="#calendarTab">Calendaris </a> </li>
                <li class="tabs-title"><a href="#resultsTab" >Resultats</a></li>
            ...
            <div class="tabs-content" data-tabs-content="example-tabs">
                <div class="tabs-panel" id="calendarTab">
                       ...
                       <table>
                           <tr><td colspan="8" align="right" style="text-align:right;"> <a href="<?php echo base_url();?>/manteniment/excelPartits.php?idLeague=<?php echo $id_league; ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></td></tr>
					...
					$visitorImage="";
                        ...
                        echo "\n\t<tr>";
                        echo "\n\t\t<td><a href='" . base_url() . "clubs/equip/" . $row->idLocal . "-" . teamUrlFormat($row->local) . "'>\n\t\t\t<img src=\"$localImage\" width=60 ></td>";
                        echo "\n\t\t<td align=right><a href='" . base_url() . "clubs/equip/" . $row->idLocal . "-" . teamUrlFormat($row->local) . "'>" . $row->local . "</a></td>";
                        echo "\n\t\t<td style='background-color:#828282; color:#fff; font-size:20px; font-weight:bold; text-align:center;'>Jornada <br />" . $row->roundName . "</td>";
                        echo "\n\t\t<td><a href='" . base_url() . "clubs/equip/" . $row->idVisitor . "-" . teamUrlFormat($row->visitor) . "'>" . $row->visitor . "</a></td>";
                        echo "\n\t\t<td><a href='" . base_url() . "clubs/equip/" . $row->idVisitor . "-" . teamUrlFormat($row->visitor) . "'>\n\t\t\t<img src=\"$visitorImage\" width=60></a></td>";
                ...
                <div class="tabs-panel" id="resultsTab">
                    ...
                    <table>
                        ...
                        foreach ($get_results_by_idLeague_and_idRound as $row):
                            echo "\n\t<tr>";
                            echo "\n\t\t<td><a href='" . base_url() . "clubs/equip/" . $row->localId . "-" . teamUrlFormat($row->local) . "'><img src=\"https://www.futsal.cat/webImages/clubsImages/" . $row->club1Image . "\" width=60 ></td>";
                            ...
                            echo "\n\t\t<td><a href='" . base_url() . "clubs/equip/" . $row->visitorId . "-" . teamUrlFormat($row->visitor) . "'><img src=\"https://www.futsal.cat/webImages/clubsImages/" . $row->club2Image . "\" width=60></a></td>";
                            echo "\n\t\t<td style='border-left:1px solid #626262;'>\n\t\t\t<i class=\"fa fa-map-o\" aria-hidden=\"true\"></i> <span style='text-transform:uppercase; font-weight:bold;'>" . $row->complexName . "</span><br />\n\t\t\t<i class=\"fa fa-map-marker\" aria-hidden=\"true\"></i> <a target=_blank href='http://maps.google.com/?q=" . urlencode($row->complexAddress) . "'>" . $row->complexAddress . "</a><br />\n\t\t\t<i class=\"fa fa-clock-o\" aria-hidden=\"true\"></i> " . invertdateformat($row->updateddatetime) . "<br />\n\t\t<i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i> <a href='http://" . base_url() . "competicio/acta/" . $row->idMatch . "-" . teamUrlFormat($row->local . "-" . $row->visitor) . "'>Veure acta</a></td>";
                            echo "\n\t</tr>";
                        endforeach;
                        ?>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>				
                            ...
                            foreach ($get_classification_by_idLeague_and_idRound as $row):
                                ...
                                echo "\n\t\t<td align=center>" . $row->playedMatches . "</a></td>";
                                echo "\n\t\t<td align=center>" . $row->wonMatches . "</td>";
                                echo "\n\t\t<td align=center>" . $row->drawMatches . "</td>";
                                echo "\n\t\t<td align=center>" . $row->lostMatches . "</td>";
                                echo "\n\t\t<td align=center>" . $row->goalsMade . "</td>";
                                echo "\n\t\t<td align=center>" . $row->goalsReceived . "</td>";
                ...
                <div class="tabs-panel" id="scorersTab">
                    <table>
                        <thead>
                            <tr>
                                <th >Gols</th>
                                <th style='text-align:left;' colspan=2>Jugador</th>
                                <th >Equip</th>
                        ...
                        <tbody><?php
                            foreach ($get_max_scorers_by_idLeague as $row):
                                ...
                                echo "\n\t<tr>";
                                echo "\n\t\t<td>" . $row->goals . "</td>";
                                echo "\n\t\t<td><a href='" . base_url() . "jugador/" . $row->idPlayer . "-" . teamUrlFormat($row->playerName) . "'><img src=\"" . base_url() . "images/dynamic/playersImages/" . $row->image . "\" width=20 ></a></td>";
...
<script>
    ...
    $(function () {
        ...
        if (tab == "calendar") {
            $("#example-tabs").foundation("selectTab", $("#calendarTab"));
        }
