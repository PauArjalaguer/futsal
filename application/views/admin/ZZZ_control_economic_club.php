                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td style='border-bottom: 2px #aaa solid;font-size: 16px; text-align: right;'><?php
                                $total = $totalPlayersToBePaid + $totalCardsToBePaid + $totalRefereedMatchesToBePaid + $totalTeamEntriesToBePaid;
                        ...
                        <tr>
                            ...
                            <td style='border-bottom: 1px #aaa solid; text-align: right;border-top: 1px #aaa solid; color:#0c0;'><?php
                                $totalPayed = $totalPaidPlayers + $totalPaidCards + $totalPaidRefereedMatches + $totalPaidTeamEntries;
                    ...
                    <table id="competitionsTable"  class="table table-bordered table-striped">       
                        ...
                        <tbody>
                            ...
                            foreach ($get_economic_control_by_idClub as $row):
                                ...
                                echo "</td>";
                                echo "\n\t\t\t\t\t\t\t\t<td>" . invertdateformatshort($row->datetime) . "</td>";
                                echo "\n\t\t\t\t\t\t\t\t<td>" . $row->type . "</td>";
                                echo "\n\t\t\t\t\t\t\t\t<td>" . substr($row->concept, 0, 45) . "</td>";
                                 echo "\n\t\t\t\t\t\t\t\t<td>" . substr($row->name, 0, 45) . "</td>";
                                if ($row->type != 'Pagament') {
                                    $neg = "-";
                                } else {
                                    $neg = "";
                                ...
                                echo "\n\t\t\t\t\t\t\t\t<td $color>" . $b . " &euro;</td>";
                                echo "\n\t\t\t\t\t\t\t\t<td style='color:transparent;width:1px; background-color:transparent;' width=1>" . $row->diff . "</td>";
                                echo "\n\t\t\t\t\t\t\t</tr>";
...
<script>
    ...
    $("#competitionsTable").DataTable({"paging": false,
        "info": false, "aaSortingFixed": [[6, 'asc']], "pageLength": 1000, "oLanguage": {"sEmptyTable": "No hi ha registres", "sInfo": "Hi ha _TOTAL_ registres. Mostrant de (_START_ a _END_)", "sLoadingRecords": "Per favor espera - Carregant...", "sSearch": "Filtre:&nbsp; ", "sLengthMenu": "Mostrar _MENU_", "oPaginate": {"sLast": "Ãšltima pÃ gina", "sFirst": "Primera", "sNext": "Següent", "sPrevious": "Anterior"}}});
