    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="box box-warning">
                ...
                echo form_open('admin/gestio_clubs/modifica_jugador/' . $id . "/" . $idTeam . "/" . $idClub, $att);
                ?>
                <div class="row">
                    <div class="col-md-4">
                        <div class="box-body">
...
<?php if($statusPercent==100){ $v="style='display:inline;' "; }else{ $v="style='display:none;'"; } ?>
                    <a  <? echo $v; ?>href="<?php echo base_url() . "admin/jugador/marca_com_validat/" . $id . "/" . $idTeam . "/" . $idClub; ?>"><button type="button" class="btn btn-success">Validar fitxa</button></a>
        ...
        <div class="col-md-2">
            <div class="box box-success">
                ...
                <div class="box-body with-border">
                    ...
                    <input type='hidden' name='playerDNIScan' value='<?php echo $DNIscan; ?>' />
                    <?php
                    if (empty($DNIscan)) {
                        $dU = "display:block;";
                        $dI = "display:none;";
