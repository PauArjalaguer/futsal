            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4"
                        ...
                        <div class="col-lg-4">
                            <label>Àrbitre:</label> 
                            <select class="form-control select2" style="width: 100%;" name="matchReferee1"><option></option>
                                <?php
                        ...
                        <div class="col-lg-4">
                            <label>Àrbitre:</label> 
                            <select class="form-control select2" style="width: 100%;" name="matchReferee2"><option></option>
                                <?php
                        ...
                        <div class="col-lg-4">
                            <label>Taula:</label>
                            <select class="form-control select2" style="width: 100%;" name="matchReferee3"><option></option>
                                <?php
