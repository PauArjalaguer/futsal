...
$out .= "<div style='width:30%; float:left; text-align:center;'>C/Guipuscoa 23-25 5è D• 08018 Barcelona<br />Telf.: 93 244 44 03<br/ >Fax: 93 247 34 83</div>";
...
$sql = "select r.name as referee,m.id ,t1.name as local ,t2.name as visitor ,r.name as referee ,r.id as idReferee ,cmr.id as idCmr, cmr.idRefereeType,km, ro.idleague, rprds.price as rPrice, rpmds.price as mPrice, rt.refereeTypeName, d.name as division, allowance, updateddatetime, l.name as league, cupprice,l.idDivision
...
while ($row1 = mysql_fetch_array($res1)) {
    ...
    if (preg_match("/Copa/", $row1['league']) or preg_match("/Four/", $row1['league'])) {
        
            $matchPrice = $row1['cupprice'] / 2;
