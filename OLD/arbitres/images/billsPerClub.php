...
$sql = "select r.name as referee,m.id ,t1.name as local ,t2.name as visitor ,r.name as referee ,r.id as idReferee ,cmr.id as idCmr, cmr.idRefereeType,km, ro.idleague, rprds.price as rPrice, rpmds.price as mPrice, rt.refereeTypeName, d.name as division
FROM matches m
...
$out .="<tr><td class='tdBottom' align=center>&nbsp;</td><td class='tdBottom' nowrap colspan=5 class='tdBottom'>&nbsp;</td><td class='tdRight ' align=right>0 &euro;</td></tr>";


$total = $matchPrice - $sum;

$out .="<tr><td colspan=5 class=' noBorder tdTop' style='border-left:0;'>&nbsp;</td><td class=' tdBottom' style='border-top:0;'  align=right>TOTAL</td><td class='tdRight tdBottom'  style='font-weight:bold;' align=right>$matchPrice &euro;</td></tr>";
