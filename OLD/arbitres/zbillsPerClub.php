...
$sql = "select r.name as referee,m.id ,t1.name as local ,t2.name as visitor ,r.name as referee ,r.id as idReferee ,cmr.id as idCmr, cmr.idRefereeType,km, ro.idleague, rprds.price as rPrice, rpmds.price as mPrice, rt.refereeTypeName, d.name as division, allowance, updateddatetime
FROM matches m
