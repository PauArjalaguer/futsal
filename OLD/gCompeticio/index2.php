            ...
            <div id="web">
                <div id="divisions" class="block">
                    ...
                    <select onChange="window.location.href=this.options[this.selectedIndex].value;">
                        <option></option>
                        <?
                        $res = mysql_query("select * from leagues where idseason=6 order by idSeason desc,name asc");
                            ...
                            <table cellpadding="3" cellspacing="0">
                                <tr>
                                    ...
                                    if (isset($_GET['r'])) {
                                        ...
                                        $query = "select * from teams_leagues_per_season td join teams t on t.id=td.idTeam where (t.id not in (select idlocal from matches where idround=" . $_GET['r'] . ") and t.id not in (select idvisitor from matches where idround=" . $_GET['r'] . ")) and idLeague=" . $_GET['l'];
                                        echo $query;
