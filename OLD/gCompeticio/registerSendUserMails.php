...
<link rel=\"stylesheet\" type=\"text/css\" href=\"http://www.futsal.cat/css/css.css\" /></head><body><div align=center><div id='shadow'><div style='border:1px solid; width:80%; text-align:left; padding:10px;' align=left>";
	 ...
	 $subject="Benvingut a la web de la Federació Catalana de Futbol Sala,$user[1].";
	...
	$message .="<p>El teu nom d'usuari és: <strong>".$user[1]."</strong></p>";
	$message .="<p>La teva contrassenya és: <strong>".$user[2]."</strong></p>";
	$message .="<p>Necessitaràs introduïr aquestes dades per a poder comentar notícies.</p>";
	$message .="<p>Aquest mail ha estat enviat a ".$user[3].".</p></div></div>";
	$message .="</body></html>";
