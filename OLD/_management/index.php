            ...
            <div id="rightContent">
                <div class="contentBox">
                    <div class="contentBoxHeader">
                        <h2>Documentaci&oacute; Eleccions</h2>
                    </div>
                    <div class="contentBoxContent">
                        <ul>
                            <li><a style='color:#424242;' href='../documentacio/Actan4.pdf'>Acta 01 de Abril de 2016</a></li>
                           
                            <li><a style='color:#424242;' href='../documentacio/Acta_JE_FUTSAL_3.pdf'>Acta 23 de març de 2016</a></li>
                           
                            <li><a style='color:#424242;' href='../documentacio/cens23032016.pdf'>Cens definitiu</a></li>
                            
                            <li><a style='color:#424242;' href='../documentacio/Acta_Futsal_12_03_2016.pdf'>Acta 12 de març de 2016</a></li>
                            
                            <li><a style='color:#424242;' href='../documentacio/Calendari_electoral.pdf'>Calendari Electoral</a></li>
                            <li><a style='color:#424242;'  href='../documentacio/Acord_convocatoria.pdf'>Acord de Convocat&ograve;ria</a></li>
                            <li><a style='color:#424242;' href='../documentacio/Reglament_electoral.pdf'>Reglament Electoral</a></li>
                        </ul>
                    </div>
                        
                </div>
                <div class='contentBoxSpacer'></div>
...
where idseason= 7 and t.idclub=$idClub and matchesPlayedWithAnotherTeam>=1 
                ...
                if (mysql_num_rows($res) > 0) {
                    ...
                    while ($row = mysql_fetch_array($res)) {
                        ...
                        if ($row['matchesPlayedWithAnotherTeam'] >= 10) {
                            $m = "Si torna a ser alineat quedarï¿½ retingut automï¿½ticament al equip patrocinador";
                        } else {
...
// echo $sql;
                ...
                $out .="<div class='contentBoxContent'>";
                $out .="<input type='text' class='playerCardEditInput' id='idClub' value='" . $row['clubCode'] . "'><label for='clubAddress' style='clear:both;'>Identificador FCFS </label><br />";
                $out .="<input type='text' class='playerCardEditInput' id='cceCode' value='" . $row['cceCode'] . "'><label for='clubAddress' style='clear:both;'>Identificador SGE </label><br />";
                $out .="<input type='text' class='playerCardEditInput' id='ClubNameCCE' value='" . $row['cceName'] . "'><label for='clubAddress' style='clear:both;'>Nom entitat CCE</label><br />";
                $out .="<input type='text' class='playerCardEditInput' id='president' value='" . $row['president'] . "'><label for='clubAddress' style='clear:both;'>President </label><br />";
                $out .="<input type='text' class='playerCardEditInput' id='vicepresident1' value='" . $row['vicepresident1'] . "'><label for='clubAddress' style='clear:both;'>Vicepresident 1 </label><br />";
                $out .="<input type='text' class='playerCardEditInput' id='vicepresident2' value='" . $row['vicepresident2'] . "'><label for='clubAddress' style='clear:both;'>Vicepresident 2 </label><br />";
                $out .="<input type='text' class='playerCardEditInput' id='boardElecte' value='" . $row['boardElected'] . "'><label for='clubAddress' style='clear:both;'>Data elecció Junta segons CCE </label><br />";
                if ($row['playedTwoLastYears'] == 1) {
                    $row['playedTwoLastYears'] = "checked";
                } else {
                    $row['playedTwoLastYears'] = "";
                }
                $out .="<label for='clubAddress' style='clear:both;'>Competició durant 2014/15 i 2015/16 </label><input type=radio " . $row['playedTwoLastYears'] . "><br />";

                if ($row['publicEntityRegister'] == 1) {
                    $row['publicEntityRegister'] = "checked";
                } else {
                    $row['publicEntityRegister'] = "";
                }
                $out .="<label for='clubAddress' style='clear:both;'>Registre púlic d'entitats </label><input type=radio " . $row['publicEntityRegister'] . "><br />";
                if ($row['censum'] == 1) {
                    $row['censum'] = "checked";
                } else {
                    $row['censum'] = "";
                }
                $out .="<label for='clubAddress' style='clear:both;'>Cens enviat per r.e.e </label><input type=radio " . $row['censum'] . "><br />";
                if ($row['updatedBoard'] == 1) {
                    $row['updatedBoard'] = "checked";
                } else {
                    $row['updatedBoard'] = "";
                }
                $out .="<label for='clubAddress' style='clear:both;'>Junta al dia segons registre </label><input type=radio " . $row['updatedBoard'] . "><br />";



                $out .="<hr /><object classid=\"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\" width=\"220\" height=\"30\" id=\"fileUploader\" align=\"middle\">
...
<!--<![endif]-->
    ...
    <!--<![endif]-->
                ...
                $out .="<input type='text' class='playerCardEditInput' id='billingAddress' value='" . $row['billing_address'] . "'><label for='playerAddress' style='clear:both;'>Adreça Fiscal <span>*</span></label><br />";
                ...
                $out .="<textarea class='playerCardEditInput' id='clubHistory' style='height:300px; width:600px;'>" . $row['description'] . "</textarea><label for='clubHistory'>Historia</label><BR />";
