...
function playerUniversityUpdate(id,idPlayer,idTeam){
    playerCardUpdateNoRefresh(idPlayer,idTeam);
    //alert(id+" "+idPlayer+" "+idTeam);
    var select=document.getElementById("playerUniversitySelect");
    var select_index = select.selectedIndex;
    var select_value=select.options[select_index].value;
    var playerUniversity=select_value;

    //var playerNumber=getElementById("playerNumber"+id).value;
    var playerNumber=3;
    ajax3 = nuevoAjax();
    ajax3.open("GET", "playerUniversityUpdate.php?playerUniversity="+playerUniversity+"&playerNumber="+playerNumber+"&idCard="+id, true);
...
function cmptScorers(hash,idClub){
    var container1=document.getElementById("rightContent");
    ajax = nuevoAjax();

    ajax.open("GET", "cmptScorers.php?hash="+hash+"&idClub="+idClub, true);
...
function cmptCards(hash,idClub){
    var container1=document.getElementById("rightContent");
    ajax = nuevoAjax();

    ajax.open("GET", "cmptCards.php?hash="+hash+"&idClub="+idClub, true);
