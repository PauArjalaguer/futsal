...
if ($_GET['string'] == md5($_GET['email'])) {
    ...
    $sql = "update cmptMatchDateChange set denied=1 where id=" . $_GET['mdc'];
//echo $sql;
...
join cmptMatchDateChange mdc on mdc.idmatch=m.id and mdc.id=" . $_GET['mdc'] . "
...
where m.id=$idMatch";
    ...
    echo "<script type='text/javascript'>alert(\"Has rebutjat el canvi d' horari.\");  window.location=\"http://www.futsal.cat\"; </script>";
    include ("../mailSender.php");
}else{
    echo "Hi ha algun error";
}
?>