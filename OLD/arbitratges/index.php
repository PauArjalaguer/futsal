                    ...
                    <li>
                        ...
                        <ul style="display:block;" >
                           ...
                           // print_r($_COOKIE);
                            ...
                            $res = mysql_query("select name,id from leagues l join rfrRefereeLeaguesPerManagerAccount rlma on rlma.idLeague=l.id  where idseason=$lastSeasonId and idManager=".$_COOKIE['userId']." order by l.order asc ");
                            //echo "select name,id from leagues l join rfrRefereeLeaguesPerManagerAccount rlma on rlma.idLeague=l.id  where idseason=$lastSeasonId and idManager=".$_COOKIE['userId']." order by l.order asc ";
