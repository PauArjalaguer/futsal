...
where -- l.idseason=$lastSeasonId  and 
    m.statusid=4
order by l.id desc,round desc,updateddatetime desc, datetime desc --  limit 0,3300";
...
while ($row = mysql_fetch_array($res)) {
    ...
    if ($a <= 1000) {
        ...
        $out .="<td class='zebra$n pointer' align=center ><a style='color:#424242;'   target=_blank href='http://www.futsal.cat/arbitres/bills.php?idMatch=".$row['id']."'>Nomenament</a><br />
        <a style='color:#424242;' target=_blank href='http://www.futsal.cat/arbitres/billsPerClub.php?idMatch=".$row['id']."'>Rebut</a><br />
        <a style='color:#424242;' target=_blank href='http://www.futsal.cat/arbitres/billsPerClub.php?idMatch=".$row['id']."&idTeam=".$row['idLocal']."&t=local'>Local</a><br />
        <a style='color:#424242;' target=_blank href='http://www.futsal.cat/arbitres/billsPerClub.php?idMatch=".$row['id']."&idTeam=".$row['idVisitor']."&t=visitor'>Visitant</a><br /></td>";
