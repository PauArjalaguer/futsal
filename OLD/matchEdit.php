...
$out .="<table class='playersTable' cellspacing=0><tr><th width=20>&nbsp;</th><th >Equip Local</th><th>Equip visitant</th><th style='text-align:center;'>Marcador</th><th width=10%>&nbsp;</th></tr>";
...
$out .="<td class='zebra$n' style='text-align:center;' ><input type='text' id='localResultInput' class='resultInput' value='" . $row['localResult'] . "'> -  <input type='text' id='visitorResultInput' class='resultInput' value='" . $row['visitorResult'] . "'></td>";
...
//Targetes
    ...
    $resPlayersL = mysql_query("
        ...
        and pts.idseason=2 order by p.name") or die(mysql_error());
    ...
    while ($rowPlayersL = mysql_fetch_array($resPlayersL)) {
        ...
        $out .="<div class='playerWithRadioDiv zebra$n' ><input type='checkbox' $checked  id='playerRadio_" . $rowPlayersL['id'] . "' onChange='matchChangePlayerStatus(" . $rowPlayersL['id'] . "," . $_GET['idMatch'] . "," . $row['localId'] . "," . $row['visitorId'] . ",\"local\");'>  " . $rowPlayersL['name'] . " " . $rowPlayersL['teamName'] . " <span id=\"goalPlayerUpdateSuccess_" . $rowPlayersL['id'] . "\"></span></div>";
    ...
    $resPlayersL = mysql_query("
        ...
        and pts.idseason=2 order by tcr.idTeamTransferer,p.name") or die(mysql_error());
    $playersLocalArray = array();
    while ($rowPlayersL = mysql_fetch_array($resPlayersL)) {
        $checked = "";
        if ($n == 1) {
        ...
        $out .="<div class='playerWithRadioDiv zebra$n' ><input type='checkbox' $checked  id='playerRadio_" . $rowPlayersL['id'] . "' onChange='matchChangePlayerStatus(" . $rowPlayersL['id'] . "," . $_GET['idMatch'] . "," . $row['localId'] . "," . $row['visitorId'] . ",\"local\");'>  " . $rowPlayersL['name'] . " <span id=\"goalPlayerUpdateSuccess_" . $rowPlayersL['id'] . "\"></span></div>";
        $teamName = $rowPlayersL['teamName'];
    }
    $out .="</div>";
    $out .="<div style='width:50%; float:left;'>";
    ...
    while ($rowPlayersV = mysql_fetch_array($resPlayersV)) {
        ...
        $out .="<div class='playerWithRadioDiv zebra$n' ><input id='playerRadio_" . $rowPlayersV['id'] . "' type='checkbox' $checked onChange='matchChangePlayerStatus(" . $rowPlayersV['id'] . "," . $_GET['idMatch'] . "," . $row['localId'] . "," . $row['visitorId'] . ",\"visitor\");'>" . $rowPlayersV['name'] . " <span id=\"goalPlayerUpdateSuccess_" . $rowPlayersV['id'] . "\"></span></div>";
    }
    $resPlayersV = mysql_query("
        select distinct p.id
            ,p.name
    ...
    while ($rowPlayersV = mysql_fetch_array($resPlayersV)) {
        ...
        $out .="<div class='playerWithRadioDiv zebra$n' ><input type='checkbox' $checked  id='playerRadio_" . $rowPlayersV['id'] . "' onChange='matchChangePlayerStatus(" . $rowPlayersV['id'] . "," . $_GET['idMatch'] . "," . $row['localId'] . "," . $row['visitorId'] . ",\"visitor\");'>  " . $rowPlayersV['name'] . "  <span id=\"goalPlayerUpdateSuccess_" . $rowPlayersV['id'] . "\"></span></div>";
