...
if (isset($_POST['new_submit'])) {
    if (!$_POST['id']) {
        ...
        $camps = "title,insertDate,updateDate, content,pathImage,categoryId";
        ...
        $sql = "update news set title='" . addslashes($_POST['newsTitle']) . "', pathImage=''" . $_POST['image'] . "', content='" . addslashes($_POST['newsText']) . "', categoryId=" . $_POST['categoryId'] . "  where id=" . $_POST['id'];
        //echo $sql;
        $res = mysql_query($sql) or die(mysql_error());
        $lastId=$_POST['id'];
    }
            ...
            <div style="border: 1px solid #ccc; border-top:0; background-color:#fff; min-height: 300px; padding:15px;">
                <form name="form1"  enctype="multipart/form-data" method="post" action="editor.php?id=<? echo $_GET['id']; ?>">
                    <table width="100%" cellpadding="6" cellspacing="0">
                        ...
                        <?
                        if ($_GET['id']) {
                            $query = "SELECT title, content,categoryId from news where id=" . $_GET['id'];
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="categoryId">
                                    ...
                                    ?>
                                </select> <input type="submit" name="new_submit" value="Enviar" />
                            </td>
                        </tr>
