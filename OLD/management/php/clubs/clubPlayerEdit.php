...
<section class="content">
    <div class="row">
        <div class="col-md-12" <? if(!$data[20]){echo "style='display:none;'";} ?>>
        ...
        <div class="col-md-10">
            ...
            <div class="box box-warning">
                ...
                ?>
                <div class="box-footer" <? echo $style; ?>>
                    ...
                    <button type="button" class="btn btn-danger" onClick="clubPlayerEditDelete(<? echo $_GET['idPlayer']; ?>, true,<? echo $data[30]; ?>)">Eliminar fitxa</button>
            ...
            <div class="box box-success">
                ...
                <div class="box-body with-border">
                    ...
                    <div id="imageContainer" style='<? echo $dI; ?>'>
                        <img src='../images/dynamic/playersImages/<? echo $data[5]; ?>?d=<? echo time(); ?>' width=100%/>
                ...
                <div class="box-body with-border">
                    ...
                    <div id="imageContainer" style='<? echo $iI; ?>'>
                        <img src='../images/dynamic/playersImages/<? echo $data[26]; ?>?d=<? echo time(); ?>' width=100%/>
