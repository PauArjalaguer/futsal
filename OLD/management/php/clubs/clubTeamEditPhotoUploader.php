...
if ($s[0] >= 600) {
   ...
   // preg_match('/jpg/', $this->filename, $extension);
    if (preg_match("/jpg/i", $destino)) {
        ...
        $files->fileRedimensionCreateJpg("../../../images/dynamic/teamsImages/" . $prefijo . ".jpg", "../../../images/dynamic/teamsImages/" . $prefijo . ".jpg", 600, $h, 100);
   }
}
if (preg_match("/jpg/i", $destino)) {
   $files->fileRedimensionCreateJpg("../../../images/dynamic/teamsImages/" . $prefijo . ".jpg", "../../../images/dynamic/teamsImages/thumb/" . $prefijo . ".jpg", 240, 120, 100);
   $files->fileRedimensionCreateJpg("../../../images/dynamic/teamsImages/" . $prefijo . ".jpg", "../../../images/dynamic/teamsImages/micro/" . $prefijo . ".jpg", 50, 50, 100);
}
...
$fp = fopen("teamImagelog.txt", "a+");
fwrite($fp, "$log");
fclose($fp);
$clubs = new Clubs();
$clubs->idTeam=$_GET['idTeam'];
$clubs->clubsTeamImageUpdate();
