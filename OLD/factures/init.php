...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="alternate" type="application/rss+xml"  title="Federaci� Catalana de Futbol Sala - Noticies" href="http://www.futsal.cat/rss/newsRss.php" />
            ...
            <div id="web">
                ...
                <div id="rightContainer">
                    ...
                    /*   $b = 1;
                      ...
                      echo "\n<div class=\"classificationWidget" . $act . "\" id=\"" . $row['id'] . "\" ><a href='http://www.futsal.cat/divisio/" . $row['id'] . "-" . str_replace(" ", "-", treuAccents($row['name'])) . "'>" . $row['name'] . "</a></div>";
                        ...
                        <div id="resultsContainer" style='display:none;'>
                            ...
                            <div align="center">
                                <a href="http://viatgesplaimont.com/">
                                    <img width="290" title="Ag&egrave;ncia oficial de la FCFS" alt="Ag&egrave;ncia oficial de la FCFS" src="http://www.futsal.cat/webImages/sponsors/plaimont.gif" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class='rightContainerShadow'  style='display:none;'>
                        ...
                        <div id="resultsContainer" sryl>
                            <h1>Lliga Catalana Femenina</h1>

                            <div align="center">
                                <a href="http://futsal.cat/">
                                    <img width="290" title="Territorials Catalanes" alt="Territorials Catalanes" src="http://www.futsal.cat/images/cartellLleida.jpg" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='rightContainerShadow'>
                        <div id="sponsorsContainer">
                            ...
                            <a href="http://www20.gencat.cat/portal/site/sge/">
                                <img width="150" src="http://www.futsal.cat/webImages/sponsors/genesport.jpg" alt="Secretaria" />
                            </a>&nbsp;
                            <a href="http://www.ufec.cat/federacions/catalana/F">
                                <img width="150" src="http://www.futsal.cat/webImages/sponsors/UFEC_1.JPG" alt="UFEC" />
                            </a>&nbsp;
                        </div>
                    </div>
                    <div class='rightContainerShadow'>
                        ...
                        <div id="resultsContainer" align="center">
                            ...
                            <img width='180' src="http://www.futsal.cat/webImages/logoecu.jpg" />
                            <br /><br />
                            <a href='http://www.futsal.cat/?f=competicio_Universitats_masculi_1'>Competici&oacute; Masculina</a>
                            <br />
                            <a href='http://www.futsal.cat/?f=competicio_Universitats_femeni_1'>Competici&oacute; Femenina</a>
