    ...
    ajax.onreadystatechange = function() {
        if (ajax.readyState == 4) {
           ...
           // container1.innerHTML = ajax.responseText;
            ...
            classificationRecalculate(idLeague,7);
...
function matchResultCheck(idMatch){
 
    var container1=document.getElementById("rightContent");
    ajax = nuevoAjax();
    ajax.open("GET", "matchResultCheck.php?idMatch="+idMatch, true);
    ...
    ajax.onreadystatechange = function() {
        if (ajax.readyState == 4) {
           ...
           // container1.innerHTML = ajax.responseText;
            document.getElementById("rowMatch_"+idMatch).style.display="none";
            //classificationRecalculate(idLeague,6);
