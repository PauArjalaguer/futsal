...
if (mysql_num_rows($r) == 0) {
    ...
    $sql = "INSERT INTO results (localResult, visitorResult, idMatch,checked) values (" . $_GET['local'] . "," . $_GET['visitor'] . "," . $_GET['idMatch'] . ",1)";
    mysql_query($sql);
...
//actualitza com a jugat
    mysql_query("update matches set statusid=4 where id=" . $_GET['idMatch']) or die(mysql_error());
    echo "Marco com a jugat";
