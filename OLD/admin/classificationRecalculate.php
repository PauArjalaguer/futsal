...
$sql="delete from classification where idLeague=$idLeague";
mysql_query($sql);
$debug="<br />ELIMINO LA LLIGA <br /> $sql";
...
$debug .= "<br />SELECCIONO TOTS ELS EQUIPS DE LA LLIGA <br />$sql";
$res = mysql_query($sql);
while ($row = mysql_fetch_array($res)) {
    ...
    $debug .="<br >Resultats de ".$row['name']."<br />".$sql2."<br />";
    ...
    while ($row2 = mysql_fetch_array($res2)) {
       $debug .= "<br />- - - - - - - - Local: ".$row2['idLocal']." Visitant: ".$row2['idVisitor']. " Gols Local:".$row2['localResult']." Gols Visitant: ".$row2['visitorResult']."<br />";
    ...
    $sql3="insert into classification (idTeam, idLeague, playedMatches, wonMatches, drawMatches,lostMatches,goalsMade,goalsReceived) values ($idTeam,$idLeague,$playedMatches,$wins,$draws,$loses,$goalsF,$goalsC)";
    mysql_query($sql3) or die(mysql_error());
    $debug .="Insert d' equips <br /> $sql3<br />";
}

$debug .="<br />ACTUALITZAR POSICIONS<br />";
$a = 1;
...
ORDER BY points DESC, playedMatches desc,goalAverage desc";
...
while ($row = mysql_fetch_array($result1)) {
    ...
    $debug .="<br />Actualitzar posicio equip ".$row['idTeam']."<br />$sql2<br />";
    mysql_query($sql2);
    $a++;
}
