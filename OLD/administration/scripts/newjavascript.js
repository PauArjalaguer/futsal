...
function clubBallsBuyingInsert(idClub){
    ...
    var price=document.getElementById("clubBallsBuyingPrice").value;
    ...
    if(amount==0){
        ...
        var container1=document.getElementById("rightContent");
        ajax = nuevoAjax();
        ajax.open("GET", " clubBallsBuyingInsert.php?idClub="+idClub+"&amount="+amount+"&price="+price, true);
...
function clubRefereeReceipts(idClub){
var container1=document.getElementById("rightContent");
    ajax = nuevoAjax();
    ajax.open("GET", "clubRefereeReceipts.php?idClub="+idClub, true);
