...
join admBallPricePerSeason aBP on aBP.idSeason=6 where datetime>'$initDate' and idClub=" . $_GET['idClub'] . " order by id desc";
...
while ($row = mysql_fetch_array($res)) {
    ...
    $r=0+$r;
    $concept = " Drets de competició de " . $row ['name'] . ".";
