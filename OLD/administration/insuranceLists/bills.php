...
$out .= "<div style='width:50%; float:left; text-align:center;'><h4>FEDERACI&Oa CATALANA DE FUTBOL SALA</h4><br />CIF: G17102823<br /> APROVADA I INSCRITA PER LA SECRETARIA GRAL. DE L'ESPORT<br />REGISTRE N&UgraveM. 4.604 - 5 MAIG 1986</div>";
$out .= "<div style='width:30%; float:left; text-align:center;'>Rambla Guipuscoa 23-25 5&eacute; D <br />08018 Barcelona <br />Telf.: 93 244 44 03<br/ >Fax: 93 247 34 83</div>";
...
while ($row1 = mysql_fetch_array($res1)) {
    ...
    if ($r != 0) {
        ...
        $outa .= "Drets de competició de " . $row1['name'] . " per a " . $row1['division'] . " t" . $seasonName;
        $out .= "Drets de competició de " . $row1['prefix'] . " - t. " . $seasonName;
