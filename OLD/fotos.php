        ...
        <table  border=0 cellspacing="20">
            ...
            if (!isset($_GET['photoset']) and !isset($_GET['tag'])) {
                ...
                for ($i = $p; $i < $t and $i < $total; $i++) {
                    ...
                    $img = "<img src=\"http://static.flickr.com/" . $server . "/" . $primary . "_" . $secret . "_m.jpg\" id=\"$primary\" alt=\"$title\" width=280 height=187  >";
            ...
            if (isset($_GET['photoset'])) {
                ...
                for ($a = $p; $a < $t and $a < $total; $a++) {
                    if (!empty($xml->photoset->photo[$a]['id'])) {
                        ...
                        $img = "<img src=\"http://static.flickr.com/" . $server . "/" . $id . "_" . $secret . "_m.jpg\" alt='i'  width=280 height=187 >";
            ...
            if (isset($_GET['tag'])) {
                ...
                for ($a = $p; $a < $t and $a < $total; $a++) {
                    ...
                    $img = "<img src=\"http://static.flickr.com/" . $server . "/" . $id . "_" . $secret . "_m.jpg\"  width=280 height=187>";
                    $big_url = str_replace("_s", "_b", $row['url']);
                    echo "<td align=left width=280><br><div style='cursor:pointer;' class='imgtable_div' ><a href='" . $serverUrl . "imatge/$id-" . treuAccents(utf8_decode($p_title)) . "'>$img</a></div></td>";
                    $c++;
                    if ($c == 3) {
                        echo "</tr><tr>";
                        $c = 0;
...
<div>
    <div class="newsPaginator" width="100%">
        ...
        <? echo "</div><div class='totalPages' style='margin-top:20px; font-weight:bold; color:#ddd; font-size:12px;'> $numberOfPages pagines</div></div>"; ?>
